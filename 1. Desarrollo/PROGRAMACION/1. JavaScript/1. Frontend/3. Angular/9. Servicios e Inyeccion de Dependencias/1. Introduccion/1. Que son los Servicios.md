...
## Que son los Servicios:
 ...
 - Un servicio **se guarda en memoria durante tiempo de ejecucion**, por lo que **si se recarga la app, pierde el estado**.
...
- **Servicio:**
	...
	@Injectable({
	  providedIn: 'root' // 👈 Permite que el servicio sea singleton
	})
