...
**HTML**:
```html
// 👇 Permite agregar muchas clases si se cumple cada condicion
<div [ngClass]="{ 'activo': isActive, 'premiumUser': isPremium }">Este div cambia de clase</div>

// 👇 Agregar una sola clase de manera condicional
